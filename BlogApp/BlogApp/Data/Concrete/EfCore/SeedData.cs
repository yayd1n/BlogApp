            ...
            if(context != null)
            {
                ...
                if(!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "yusufaydin", Name="Yusuf Aydın" , Email="info@yusufaydin.com",Password="123456",Image = "p1.jpg"},
                        new User { UserName = "sadikturan", Name="Sadık Turan" , Email="info@sadikturan.com",Password="654321",Image = "p2.jpg"}
                    );
                    context.SaveChanges();
                }
